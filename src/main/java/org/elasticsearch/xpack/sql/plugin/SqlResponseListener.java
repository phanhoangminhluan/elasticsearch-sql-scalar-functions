...
public class SqlResponseListener extends RestResponseListener<SqlQueryResponse> {
    ...
    public SqlResponseListener(RestChannel channel, RestRequest request, SqlQueryRequest sqlRequest) {
        super(channel);
    ...
    public RestResponse buildResponse(SqlQueryResponse response) throws Exception {
        ...
        // XContent branch
        if (mediaType.isTextFormat() == false) {
            XContentType type = mediaType.xContentType();

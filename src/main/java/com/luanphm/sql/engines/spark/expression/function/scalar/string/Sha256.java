 ...
 * Created on: 2021.12.29 21:11
 */
public class Sha256 extends UnaryStringFunction {


    public Sha256(Source source, Expression field) {
        super(source, field);
    }
    ...
    protected StringProcessor.StringOperation operation() {
        return StringProcessor.StringOperation.SHA256;
    }
}

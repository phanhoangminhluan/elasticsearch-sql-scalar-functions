 ...
 * Created on: 2021.12.29 21:02
 */
public class Sha1 extends UnaryStringFunction {


    public Sha1(Source source, Expression field) {
        super(source, field);
    }
    ...
    protected StringProcessor.StringOperation operation() {
        return StringProcessor.StringOperation.SHA1;
    }
}

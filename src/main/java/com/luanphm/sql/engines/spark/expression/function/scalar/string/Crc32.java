 ...
 * Created on: 2021.12.29 20:32
 */
public class Crc32 extends UnaryStringFunction {


    public Crc32(Source source, Expression field) {
        super(source, field);
    }
    ...
    protected StringProcessor.StringOperation operation() {
        return StringProcessor.StringOperation.CRC32;
    }
}

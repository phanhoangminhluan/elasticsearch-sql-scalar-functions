...
public abstract class AbstractRestSqlQueryAction extends BaseRestHandler {
    ...
    public List<Route> routes() {
        return Collections.unmodifiableList(Arrays.asList(
                new Route(RestRequest.Method.GET, getDatabaseEngine().sqlQueryEngine.endpoint),
                new Route(RestRequest.Method.POST, getDatabaseEngine().sqlQueryEngine.endpoint)
        ));
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client)
        ...
        return channel -> client.execute(getDatabaseEngine().sqlQueryEngine.action, sqlRequest, new RestResponseListener<SqlQueryResponse>(channel) {
            @Override
